...
## Project Overview
- **Total Files**: 190
- **Documentation System**: Obsidian Vault with 95 markdown files
- **Automation Scripts**: 50 Python scripts + 29 shell scripts
...
│   ├── fix_template.sh
│   └── update_inbox_with_template.py
├── portable-obsidian-tools/  # Universal markdown processing toolkit
│   ├── cursor-rules-templates/
│   │   ├── large-vault-safety.md
│   │   ├── obsidian-syntax-preservation.md
│   │   ├── portable-tools-integration.md
│   │   ├── README.md
│   │   └── selection-scope-obsidian.md
│   ├── markdown-processing/
│   │   ├── clean_all_markdown.sh
│   │   ├── cleanup_markdown.py
│   │   ├── cleanup_markdown_batch.py
...
## Summary Statistics
- **Total Project Files**: 190
- **Markdown Documentation**: 95 files
- **Python Scripts**: 50 automation tools
- **Shell Scripts**: 29 utilities
...
- **File Organization**: Structured hierarchy with 190 total files
